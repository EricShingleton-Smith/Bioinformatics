...
def countNucFrequency(seq):
    ...
    for nuc in seq:
        tmpFreqDict[nuc] += 1
    return tmpFreqDict["A"], tmpFreqDict["C"], tmpFreqDict["G"], tmpFreqDict["T"]
...
def all_proteins_from_orfs(seq, startReadPos=0, endReadPos=0, ordered=False):
    '''Compute all possible proteins for all opening reading frames'''
    '''Protine Search DB: https://www.ncbi.nlm.nih.gov/'''
